-- UAT Hotfix 4: Operational Day Foundation & Global Liquid Toasts

-- 1. Redefine apply_tracker_action_impl with 06:00 AM Operational Day logic
...
begin
  ...
  if v_is_flexible then
    -- For flexible shifts, we use the simple 06:00 AM cutoff directly on p_now
    ...
    -- Calculate the cycle calendar date (cycle_date)
    declare
    ...
    begin
      ...
      -- Operational Date is shifted back by 1 day if the shift starts before 06:00 AM
...
-- 2. Redefine execute_cron_state_machine with 06:00 AM Operational Day logic
