-- Migration: Correct worker_status column names in sync_absensi_edit_impl RPC
...
BEGIN
  ...
  -- 7. If p_date = TODAY: Update worker_status operational state (One-Way Truth with correct columns)
