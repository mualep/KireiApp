-- R2C-D manual tracker BREAK_LATE side effect.
...
is 'Private SECURITY DEFINER tracker action implementation. R2C-D adds transaction-bound manual BREAK_LATE records when LANJUT closes an overdue break.';
