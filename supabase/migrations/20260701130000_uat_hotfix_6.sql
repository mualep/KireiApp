-- UAT Hotfix 6: Absolute Timezone, Schema Cache Reload, & UI Consistency

-- 1. Redefine apply_tracker_action_impl with explicit WIB hour extraction
...
-- 2. Redefine execute_cron_state_machine with explicit WIB hour check
