-- Migration: Fix Cancel Start RPC Columns, Whitelist & Exception Handlers
-- 1. Redefine app_private.apply_tracker_action_impl with CANCEL_START in whitelist and current_status column updates
...
begin
  ...
  if v_action = 'CANCEL_START' then
    v_attendance_date := v_shift_active_date;
  end if;
